              ...
              <div className="bg-slate-800/60 rounded-2xl p-6 border border-slate-600/30 flex items-center justify-center min-h-[450px]">
                {isImageUrl ? (
                  <img
                    src={employee.GAFETE}
                    alt="Gafete"
                    className="max-w-full max-h-[400px] rounded-lg object-contain shadow-xl"
                    crossOrigin="anonymous"
                    referrerPolicy="no-referrer"
                    onError={(e) => {
                      e.target.onerror = null
                      e.target.parentNode.innerHTML = '<div class="text-slate-400 text-center p-8">No hay imagen disponible</div>'
                    }}
                  />
